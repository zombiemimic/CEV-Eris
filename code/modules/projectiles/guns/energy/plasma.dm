/obj/item/gun/energy/plasma
	...
	init_firemodes = list(
		...
		list(mode_name="Sear", mode_desc="A two-round burst of plasma, for dealing with unruly crowds", projectile_type=/obj/item/projectile/plasma/light, fire_sound='sound/weapons/energy/burn.ogg', burst=2, fire_delay=12, charge_cost=20, icon="burst", projectile_color = "#0000FF"),
...
/obj/item/gun/energy/plasma/cassad
	...
	init_firemodes = list(
		...
		list(mode_name="Burst", mode_desc="A two-round burst of plasma, for dealing with unruly crowds", projectile_type=/obj/item/projectile/plasma/light, fire_sound='sound/weapons/Taser.ogg', burst=2, fire_delay=12, charge_cost=20, icon="burst", projectile_color = "#00FFFF")
	)
